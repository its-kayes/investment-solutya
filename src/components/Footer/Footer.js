...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-[#896EFF] text-black">
                <div>
            ...
            <footer class="footer px-10 py-4 bg-[#896EFF] text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p> <span className='font-bold'> Green Life Inc. </span> <br />Providing reliable tech since 2000</p>
                </div>
