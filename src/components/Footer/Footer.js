...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-[#3333cc] text-white">
                <div>
                    <i class="text-3xl text-black font-bold">Services</i>
                ...
                <div>
                <i class="text-3xl text-black font-bold">Company</i>
                ...
                <div>
                    <i class="text-3xl text-black font-bold">Legal</i>
                    <a class="link link-hover">Terms of use</a>
                    <a class="link link-hover">Privacy policy</a>
                    <a class="link link-hover">Cookie policy</a>
                </div>
            </footer>
            <footer class="footer px-10 py-4 bg-[#3333cc] text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <img src="green-life-inc.jpeg" width={50} height={20} alt="" />
                    <p className='text-white'> <span className='font-bold text-white'> Green Life Inc. </span> <br />Providing reliable tech since 2000</p>
                </div>
